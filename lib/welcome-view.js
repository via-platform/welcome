...
module.exports = class WelcomeView {
        ...
        return (
            <div className='welcome'>
                ...
                <div className='welcome-body'>
                    ...
                    <div className='links'>
                        <div className='link btn' onclick={this.didClickAddExchange}>Add An Exchange</div>
    ...
    didClickAddExchange(){
        via.workspace.open('via://settings/exchanges');
    }
    ...
    didClickCustomize(){
        via.applicationDelegate.openExternal('https://via.world/support/guides/interface');
    }

    didClickGuides(){
        via.applicationDelegate.openExternal('https://via.world/support');
    }
